...
To run the script, you must do so in batch (i.e., non-interactively).  First save its contents to the file \code{my_script.r}, and then open a \incmaclin{terminal}\incall{/}\incwin{command prompt}.
%
